...
<html>
	<head>
		...
		<title>Тестовое задание - MODX Revolution</title>
                <base href="[[!++site_url]]" />
...
<div class="container">
   <div class="container_left">
	...
	<nav id="menu">
		<ul class=""><li class="first"><a href="index.php?id=2" >Каталог товаров</a></li><li><a href="index.php?id=3" >Новости и акции</a></li><li><a href="index.php?id=4" >Наши услуги</a></li><li><a href="index.php?id=5" >Портфолио</a></li><li><a href="index.php?id=6" >Блог</a></li><li><a href="index.php?id=7" >Контакты</a></li><li><a href="index.php?id=8" >О компании</a></li><li><a href="index.php?id=9" >Отзывы о нас</a></li><li><a href="index.php?id=10" >Доставка и оплата</a></li><li class="last"><a href="index.php?id=11" >Дизайнеры</a></li></ul>
	</nav>
	<nav id="menu-desktop">
		<ul class=""><li class="first"><a href="index.php?id=2" >Каталог товаров</a></li><li><a href="index.php?id=3" >Новости и акции</a></li><li><a href="index.php?id=4" >Наши услуги</a></li><li><a href="index.php?id=5" >Портфолио</a></li><li><a href="index.php?id=6" >Блог</a></li><li class="last"><a href="index.php?id=7" >Контакты</a></li></ul>
	</nav>
	<div class="block">
		<ul class=""><li class="first"><a href="index.php?id=8" >О компании</a></li><li><a href="index.php?id=9" >Отзывы о нас</a></li><li><a href="index.php?id=10" >Доставка и оплата</a></li><li class="last"><a href="index.php?id=11" >Дизайнеры</a></li></ul>
	</div>
	<div class="number">
  ...
  <img src="manager/templates/zadanie/img/photo.png" alt="Декоративные покрытия">
  <div class="text">
    <div class="title">
      <h3>Декоративные покрытия</h3>
      <h4>От лучших производителей</h3>
    </div>
...
<html>
    ...
    '[[$container_left]]' => '<div class="container_left">
	<div class="logo"></div>
	<p class="desc">Интернет магазин отделочных материалов и дизайна.</p>
	<nav id="menu">
		<ul class=""><li class="first"><a href="index.php?id=2" >Каталог товаров</a></li><li><a href="index.php?id=3" >Новости и акции</a></li><li><a href="index.php?id=4" >Наши услуги</a></li><li><a href="index.php?id=5" >Портфолио</a></li><li><a href="index.php?id=6" >Блог</a></li><li><a href="index.php?id=7" >Контакты</a></li><li><a href="index.php?id=8" >О компании</a></li><li><a href="index.php?id=9" >Отзывы о нас</a></li><li><a href="index.php?id=10" >Доставка и оплата</a></li><li class="last"><a href="index.php?id=11" >Дизайнеры</a></li></ul>
    ...
    '[[$footer]]' => '		<script src="manager/templates/zadanie/js/jquery-3.6.0.min.js"></script>
		<script src="manager/templates/zadanie/js/owl.carousel.min.js"></script>
		<script src="manager/templates/zadanie/js/mmenu.js"></script>
		<script src="manager/templates/zadanie/js/jquery.modal.min.js"></script>
		<script src="manager/templates/zadanie/js/script.js"></script>
...
<html>
	...
	<body>
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '<div class="container_left">
	<div class="logo"></div>
	<p class="desc">Интернет магазин отделочных материалов и дизайна.</p>
	<nav id="menu">
		[[pdoMenu?
	...
	<div class="number">
		...
		<a href="#modal"  class="btn" rel="modal:open">Заказать звонок</a>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div class="container_left">
	<div class="logo"></div>
	<p class="desc">Интернет магазин отделочных материалов и дизайна.</p>
	<nav id="menu">
		[[pdoMenu?
	...
	<div class="number">
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '		<script src="manager/templates/zadanie/js/jquery-3.6.0.min.js"></script>
		<script src="manager/templates/zadanie/js/owl.carousel.min.js"></script>
		<script src="manager/templates/zadanie/js/mmenu.js"></script>
		<script src="manager/templates/zadanie/js/jquery.modal.min.js"></script>
		<script src="manager/templates/zadanie/js/script.js"></script>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '		<script src="manager/templates/zadanie/js/jquery-3.6.0.min.js"></script>
		<script src="manager/templates/zadanie/js/owl.carousel.min.js"></script>
		<script src="manager/templates/zadanie/js/mmenu.js"></script>
		<script src="manager/templates/zadanie/js/jquery.modal.min.js"></script>
		<script src="manager/templates/zadanie/js/script.js"></script>
